...
export interface SimulationState {
  ...
  periodPlanningActive: boolean;
  periodPlanningSeedTarget: string | null;
  periodPlannedThrough: string | null;
  periodPlanningBacklog: number;
  periodPlanningBatchCount: number;
  periodPlanningLastBatchPlanned: number;
  ...
  periodTickLastWaitHorizon: string | null;
  periodTickLastWaitPlannedThrough: string | null;
  startedAt: string | null;
